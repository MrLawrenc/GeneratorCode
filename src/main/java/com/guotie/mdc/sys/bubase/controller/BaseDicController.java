...
public class BaseDicController {
    ...
    public ResponseResult selectByConditions(Map<String, Object> params) {
        ...
        stringStringHashMap.put("pageSize", 2);
        System.out.println(service.selectByConditions(stringStringHashMap));
        return ResponseResult.success(service.selectByConditions(stringStringHashMap));
    }
